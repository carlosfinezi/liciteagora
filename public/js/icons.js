/* icons.js — Sprite SVG de ícones premium (Lucide-inspired) para o ERP.
 *
 * Uso:
 *   <script src="/js/icons.js"></script>   — injeta sprite no início do <body>
 *   Em HTML:  <svg class="ic"><use href="#i-wallet"/></svg>
 *   Em JS:    icon('wallet')  → retorna string '<svg class="ic">...</svg>'
 *             icon('wallet', 'ic-sm')
 *
 * Tamanhos: .ic (20px, padrão), .ic-sm (16px), .ic-lg (24px), .ic-xl (32px).
 */
(function() {
  if (window.__lctIconsLoaded) return;
  window.__lctIconsLoaded = true;

  // Sprite minimalista (stroke-based, 24x24, currentColor)
  const SPRITE = `<svg xmlns="http://www.w3.org/2000/svg" style="display:none;" aria-hidden="true">
    ...
    <symbol id="i-trash"        viewBox="0 0 24 24"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-2 14a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2L5 6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></symbol>
    ...
    <symbol id="i-settings"     viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09a1.65 1.65 0 0 0-1-1.51 1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09a1.65 1.65 0 0 0 1.51-1 1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></symbol>
    ...
    <symbol id="i-home"         viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2v-5H10v5a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9"/></symbol>
    <symbol id="i-bank"         viewBox="0 0 24 24"><line x1="3" y1="21" x2="21" y2="21"/><line x1="5" y1="9" x2="19" y2="9"/><line x1="5" y1="21" x2="5" y2="9"/><line x1="19" y1="21" x2="19" y2="9"/><polygon points="12 3 2 9 22 9 12 3"/><line x1="9" y1="21" x2="9" y2="12"/><line x1="15" y1="21" x2="15" y2="12"/></symbol>
    ...
    <symbol id="i-alarm"        viewBox="0 0 24 24"><path d="M6 3 3 6"/><path d="m21 6-3-3"/><path d="m18 21 2-2"/><path d="m4 21-2-2"/><circle cx="12" cy="13" r="8"/><path d="M12 9v4l2 2"/></symbol>
  </svg>`;

  // Injeta sprite no início do body (após DOMContentLoaded)
  function injetar() {
    if (!document.body) { requestAnimationFrame(injetar); return; }
    if (document.getElementById('lct-icons-sprite')) return;
    const wrap = document.createElement('div');
    wrap.id = 'lct-icons-sprite';
    wrap.innerHTML = SPRITE;
    document.body.insertBefore(wrap, document.body.firstChild);
  }
  injetar();

  // Helper global — retorna string SVG pronta para uso inline em template literals
  window.icon = function(name, cls = 'ic') {
