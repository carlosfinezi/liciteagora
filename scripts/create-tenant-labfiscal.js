#!/usr/bin/env node
// One-off: cria tenant interno "labfiscal" — laboratório da NF manual + motor de
// tributação por regime. Separado do "jaagricola" (lab de migração do Solution)
// de propósito: aqui entram dados descartáveis de teste, lá não.
