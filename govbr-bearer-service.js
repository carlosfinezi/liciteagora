...
async function solve2captcha(pageurl, ua) {
  ...
  const c = await tc2Req('/createTask', { clientKey: TWOCAPTCHA_KEY, task: { type: 'HCaptchaTaskProxyless', websiteURL: pageurl, websiteKey: SITEKEY_FALLBACK, isInvisible: false, userAgent: ua } });
